...
namespace sylar{
    namespace http{
        ...
        sylar::http::HttpResponse::ptr response,
        sylar::http::HttpSession::ptr session)  {
            static const std::string& RSP_BODY="<html><head><title>404 Not Found</title></head><body><center><h1>404 Not Found</h1></center><hr><center>sylar</center></body></html>";
            response->setHeader("Content-Type","text/html");
            response->setBody(RSP_BODY);
            response->setStatus(sylar::http::HttpStatus::NOT_FOUND);
            response->setHeader("Server","sylar");
